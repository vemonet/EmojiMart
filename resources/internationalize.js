...
async function main() {
  ...
  let martData = JSON.parse(readFileSync("emoji-mart/packages/emoji-mart-data/sets/14/native.json", "utf-8"));
  ...
  for (let lang of langs) {
    ...
    try {
      ...
      const langFull = JSON.parse(readFileSync(`cldr-json/cldr-json/cldr-annotations-full/annotations/${lang}/annotations.json`, "utf-8"));
      const langDerived = JSON.parse(readFileSync(`cldr-json/cldr-json/cldr-annotations-derived-full/annotationsDerived/${lang}/annotations.json`, "utf-8"));
